...
use crate::cli::{Cli, Commands, HtmlArgs, StartArgs, StopArgs};
...
use crate::paths::{
    active_state_file, audio_device_cache_file, ensure_dirs, last_session_file,
    parakeet_server_log_file, parakeet_server_pid_file, perf_log_file, root_dir, sessions_dir,
